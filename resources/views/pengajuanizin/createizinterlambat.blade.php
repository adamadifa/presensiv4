...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">Izin Terlambat</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
@endsection
                ...
                <div class="row" style="margin-bottom:0 !important">
                    <div class="col-12">
                        <div class="input-icons">
                            ...
                            <input type="text" id="dari" name="dari" class="form-control datepicker input-field" placeholder="Tanggal"
                                autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="input-icons">
                            ...
                            <input type="text" id="jam_terlambat" name="jam_terlambat" class="form-control input-field timepicker"
                                placeholder="Jam Terlambat (HH:MM)" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="row">
