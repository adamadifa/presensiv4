...
<div class="appHeader bg-primary text-light">
    ...
    <div class="pageTitle">Izin Pulang</div>
    <div class="right"></div>
</div>
<!-- * App Header -->
@endsection
...
<div class="row" style="margin-top:70px;">
    <div class="col">
        <form method="POST" action="/pengajuanizin/store" id="frmPengajuanizin" enctype="multipart/form-data">
            ...
            <input type="hidden" name="jenis_izin" value="PL">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="input-icons">
                        ...
                        <input type="text" id="jam_pulang" name="jam_pulang" class="form-control input-field timepicker" placeholder="Jam Pulang (HH:MM)" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="row">
