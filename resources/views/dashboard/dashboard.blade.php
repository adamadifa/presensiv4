                    ...
                    <div class="card-body">
                        <div class="presencecontent">
                            ...
                            <div class="presencedetail">
                                ...
                                <span>{{ $presensihariini != null ? date("H:i:s",strtotime($presensihariini->jam_in)) : 'Belum Scan' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="historicontent">
                                    <div class="historidetail1">
                                        ...
                                        <div class="datepresence">
                                            ...
                                            <span class="timepresence">{{ date("H:i:s",strtotime($d->jam_in)) }} {!! $presensihariini != null && $d->jam_out != null ? "- ".date("H:i:s",strtotime($d->jam_out)) : '<span class="danger"> - Belum Pulang</span>' !!}</span><br>
