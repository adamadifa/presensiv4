        ...
        <form method="POST" action="/pinjaman/store" id="frmPinjaman">
            ...
            <div class="row" style="margin-bottom: 0">
                <div class="col">
                    <div class="input-icons">
                        ...
                        <input type="text" id="tgl_pinjaman" name="tgl_pinjaman" class="form-control datepicker input-field" placeholder="Tanggal Pinjaman" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="row" style="margin-bottom: 0">
                <div class="col">
                    <div class="input-icons">
                        ...
                        <input type="text" id="jml_pinjaman" style="text-align: right" name="jml_pinjaman" class="form-control  input-field" placeholder="Jumlah Pinjaman" autocomplete="off">
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="margin-bottom: 0">
                <div class="col">
                    <div class="input-icons">
                        <ion-icon name="document-outline" class="icon"></ion-icon>
                        <input type="text" id="angsuran" name="angsuran" class="form-control  input-field" placeholder="Angsuran" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="row" style="margin-bottom: 0">
                <div class="col">
                    <div class="input-icons">
                        <ion-icon name="document-outline" class="icon"></ion-icon>
                        <input type="text" id="jml_angsuran" name="jml_angsuran" class="form-control  input-field" placeholder="Jumlah Angsuran / Bulan" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="row" style="margin-bottom: 0">
                <div class="col">
                    <div class="input-icons">
                        <ion-icon name="calendar-outline" class="icon"></ion-icon>
                        <input type="text" id="mulai_cicilan" style="text-align: right" name="mulai_cicilan" class="form-control  input-field" placeholder="Mulai Cicilan" autocomplete="off">
                    </div>
                </div>
            </div>
        </form>
